...
The app is designed with a user-friendly interface, ensuring accessibility for users of all ages and technical expertise levels. Creating and posting content is made simple, requiring just a few clicks.

● **Blogging platform** :
BlogWeet is  a social media platform exclusively dedicated to blogging. Users can create, post, and share their blogs, facilitating the expression of thoughts, opinions, and perspectives through written content.
...
You can see the live demo at: https://blogweet.vercel.app/
...
Check out the <a href="https://github.com/AKD-01/blogweet/blob/main/CODE_OF_CONDUCT.md">Code of Conduct</a> to know an inclusive environment that respects all contributions.

## License
The Blogweet is <a href="https://github.com/AKD-01/blogweet/blob/main/LICENSE">licensed</a> under MIT License.
...
```
```markdown
NOTE: Please create a .env.local file in the root folder and add yours API's from Firebase or add the following:
...
:point_right: You are advised to make your own branch for contributing.     

:point_right: Now you can either create an issue to request some changes or add features or improve styling.   

:point_right: You can also work on already created issues, but the first comment on that issue, so that you get assigned the label of `gssoc23` and start working that issue and once you complete, you can raise a pull request.     
...
## Our Contributors 🤝
   Thanks to all the contributors. We value the time and effort you put into contributing to this project.
 <p align="center">
